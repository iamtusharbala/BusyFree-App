...
$email="tusharbala284@gmail.com";// user Email id

$subject="Shop Availability Alert";
$from_name="Notification";
$msg="$shop_name is currently Available"; // HTML message
...
curl_setopt ($ch,CURLOPT_POSTFIELDS,"email=$email&msg=$msg&subject=$subject");

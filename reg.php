...
<head>
    ...
    <title>User Sign Up | Busyfree</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action='insert.php' method="POST" class="register-form" id="register-form" enctype="multipart/form-data" >
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="signup" style="background-color:#FF9F3F" id="signup" class="form-submit" value="Register"/>
                            </div>
                        </form>
                    </div>
